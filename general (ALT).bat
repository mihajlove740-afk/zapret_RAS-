...
:: ============================================================
:: МЕГА-АГРЕССИВНАЯ СТРАТЕГИЯ (для слабого интернета/телефона)
:: ============================================================
...
:: 1. UDP 443 - ОСНОВНОЙ (МАКСИМАЛЬНАЯ АГРЕССИЯ)
...
:: 2. UDP ИГРЫ/ГОЛОС (Discord, STUN, Zoom, Teams)
...
:: 3. TCP СПЕЦПОРТЫ (Discord, Google Chat)
...
:: 4. TCP 443 - GOOGLE (YouTube, Gmail)
...
:: 8. UDP GameFilter - МАКСИМАЛЬНАЯ АГРЕССИЯ
